...
def export_ics(
    ...
    return StreamingResponse(
        ...
        headers={
            "Content-Disposition": "attachment; filename=my-salsa-events.ics"
        },
    )
...
def export_xlsx(
    ...
    ws.append(["Title", "Date", "Start Time", "End Time", "Location", "Description", "Price"])
    ...
    return StreamingResponse(
        ...
        headers={
            "Content-Disposition": "attachment; filename=my-salsa-events.xlsx"
        },
    )
