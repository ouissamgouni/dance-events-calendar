...
export function StatusBar() {
  ...
  return (
    <div
      className="shrink-0 bg-gray-100 text-gray-600 border-t border-gray-200 z-[9999] relative flex items-center justify-end select-none"
      style={{ height: STATUS_BAR_HEIGHT, fontFamily: 'system-ui, -apple-system, sans-serif' }}
    >
      {/* QA segment */}
      {hasQa && (
        <>
