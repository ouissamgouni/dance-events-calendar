        ...
        <li className="flex items-center justify-between gap-2 px-3 py-2">
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
                <button
                    ...
                    className="px-2 py-0.5 text-[11px] rounded bg-sky-50 text-sky-700 hover:bg-sky-100 disabled:opacity-40"
                ...
                <button
                    ...
                    onClick={onReject}
                    disabled={disabled || loading}
                    className="px-2 py-0.5 text-[11px] rounded bg-slate-100 text-slate-600 hover:bg-slate-200 disabled:opacity-40"
