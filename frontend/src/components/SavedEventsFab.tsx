...
/**
 * "Mine" CTA — a single pill that links straight to `/my-calendar`. Used in
 * two places: as the persistent entry point in the explorer top bar, and
 * (wrapped by `MyCalendarFab`) as the always-visible floater. The floater
 * adds a dismiss button externally; this component itself stays minimal.
 *
 * Renders nothing when the user has zero saved/going events.
 */
export default function SavedEventsFab() {
    ...
    // Deduped union: an event saved AND going shouldn't double-count.
