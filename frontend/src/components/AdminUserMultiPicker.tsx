        ...
        <div className="space-y-1.5">
            ...
            {open && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
                    <div className="w-full max-w-md max-h-[80vh] flex flex-col border border-gray-200 bg-white shadow-lg">
                        ...
                        <div className="flex-1 overflow-y-auto px-1 py-1">
                            ...
                            {!loading && results.map((row) => {
                                ...
                                return (
                                    <label
                                        key={row.user_id}
                                        className="flex items-center gap-2 px-2 py-1 text-[11px] hover:bg-emerald-50 cursor-pointer"
                                    >
                                        <input
                                            type="checkbox"
                                            checked={checked}
