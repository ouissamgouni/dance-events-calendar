...
export function makeUser(overrides: Partial<AuthUser> = {}): AuthUser {
    return {
        ...
        email_review_prompt_enabled: true,
        push_review_prompt_enabled: false,
        email_milestone_unlocked_enabled: true,
...
export const handlers = [
    ...
    http.get('*/api/settings', () =>
        HttpResponse.json({
            ...
            event_card_save_show_stats_enabled: false,
            event_card_imgoing_show_stats_enabled: false,
            event_card_imgoing_location_bottom_enabled: true,
            event_card_show_people_icon_enabled: false,
            explorer_event_card_card_style_enabled: false,
            for_you_event_cards_date_first_layout_enabled: false,
            ...
            review_prompt_lookback_hours: 24,
            for_you_review_window_days: 180,
            review_mood_headline_min_reviews: 3,
        }),
    ),
